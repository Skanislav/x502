...
// --- placeholder smart-wallet ABIs ---
// Real values written by `pnpm --filter @x502/shared extract-abis` after
// `forge build`. Local tsc needs these to compile demo/scripts/seed.ts;
// CI's drift check rejects the merge if these stay empty.
export const mockSmartWalletAbi = [] as const;
export const mockSmartWalletBytecode = "0x" as `0x${string}`;
...
export const mockSmartWalletFactoryBytecode = "0x" as `0x${string}`;
